...
test\Services\test_fileoperations.py ....                                                                                [ 90%] 
test\Services\test_logoperations.py ...                                                                                  [ 94%]
test\Services\test_parentparser.py F.FF.                                                                                 [100%]
...
mock_parse_annual = <MagicMock name='parseAnnualStmntFile' id='1501421687040'>
mock_download = <MagicMock name='DownloadServerFilesToLoad' id='1501421646320'>
mock_dbops_constructor = <MagicMock name='dboperations' id='1501421342144'>
...
self = <MagicMock name='parseAnnualStmntFile' id='1501421687040'>
...
mock_load_vpa = <MagicMock name='LoadVPADataToSADRD' id='1501422820752'>
mock_load_cusip = <MagicMock name='Load_FundCusipDetails' id='1501422848896'>
mock_execute_view = <MagicMock name='executeView_GetDetails' id='1501422885280'>
mock_dbops_constructor = <MagicMock name='dboperations' id='1501422905616'>
...
mock_execute_view = <MagicMock name='executeView_GetDetails' id='1501424032112'>
mock_dbops_constructor = <MagicMock name='dboperations' id='1501424056160'>
...
E       TypeError: parentparser() missing 1 required positional argument: 'Year'

test\Services\test_parentparser.py:107: TypeError
====================================================== warnings summary ======================================================= 
...
FAILED test/Services/test_parentparser.py::TestParentParser::test_parentparser_generate_sadrd_report_no_refresh - TypeError: parentparser() missing 1 required positional argument: 'Year'
========================================== 3 failed, 82 passed, 10 warnings in 4.06s ========================================== 
