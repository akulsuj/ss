...
======================================================= FAILURES ======================================================== 
_______________________________ TestParentParser.test_parentparser_qualpctftc_file_error ________________________________ 

self = <test.Services.test_parentparser.TestParentParser testMethod=test_parentparser_qualpctftc_file_error>
mock_download = <MagicMock name='DownloadServerFilesToLoad' id='1937913874896'>
mock_dbops_constructor = <MagicMock name='dboperations' id='1937914776352'>
...
E           TypeError: parentparser() missing 2 required positional arguments: 'importType' and 'Year'
...
FAILED test/Services/test_parentparser.py::TestParentParser::test_parentparser_qualpctftc_file_error - TypeError: parentparser() missing 2 required positional arguments: 'importType' and 'Year'
======================================= 1 failed, 86 passed, 10 warnings in 4.34s =======================================
