...
=========================================================== ERRORS ============================================================ 
___________________________________ ERROR collecting test/Entities/test_SADRD_Dataparser.py ___________________________________ 
ImportError while importing test module 'C:\Sujith\Projects\SADRD\FinanceIT_SADRD\API\test\Entities\test_SADRD_Dataparser.py'.  
Hint: make sure your test modules/packages have valid Python names.
Traceback:
C:\Program Files\Python39\lib\importlib\__init__.py:127: in import_module
    return _bootstrap._gcd_import(name[level:], package, level)
test\Entities\test_SADRD_Dataparser.py:7: in <module>
...
ERROR test/Entities/test_SADRD_Dataparser.py
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Interrupted: 1 error during collection !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
================================================ 10 warnings, 1 error in 4.94s ================================================ 
